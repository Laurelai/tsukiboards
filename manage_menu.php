 ...
 * arcNET 0.2
 *
 * arcNET uses core code from ONEECHAN 1.0.2 and KUSABA X 0.9.3
 *
 * http://tsukihi.me
 *
...
if (!$manage_class->ValidateSession(true)) {
    ...
    $tpl_links .= "</strong>";
    $tpl_links .= '<li><a href="' . KU_WEBFOLDER . '" target="_top">' . _gettext('Oneechan') . '</a></li>' . "\n";
    ...
    '<ul>
    <li><a href="http://mail.oneechan.org/" target="_blank">' . _gettext('Staff Email System') . '</a></li>
    ...
    // Administration
    if ($manage_class->CurrentUserIsAdministrator()) {
        $tpl_links .= section_html(_gettext('Templates &amp; Appearance'), 'siteadministration', false) .
        '<ul>
        <li><a href="manage_page.php?action=index">' . _gettext('Index Page Management') . '</a></li>
        <li><a href="manage_page.php?action=faq">' . _gettext('FAQ Page Management') . '</a></li>
        <li><a href="manage_page.php?action=news">' . _gettext('News') . '</a></li>' . "\n" . '</a></li>
        <li><a href="manage_page.php?action=rules">' . _gettext('Rules Page Management') . '</a></li>
        <li><a href="manage_page.php?action=staffpage">' . _gettext('Staff Page Management') . '</a></li>
        <li><a href="manage_page.php?action=legal">' . _gettext('Legal Page Management') . '</a></li>
        <li><a href="manage_page.php?action=boardman">' . _gettext('Edit Board Table') . '</a></li>
        <li><a href="manage_page.php?action=addannouncement">' . _gettext('Edit Announcements') . '</a></li>
        <li><a href="manage_page.php?action=blotter">' . _gettext('Blotter') . '</a></li>
        <li><a href="manage_page.php?action=templates">' . _gettext('Edit templates') . '</a></li>
        <li><a href="manage_page.php?action=tempheader">' . _gettext('Edit Main Header') . '</a></li>
        <li><a href="manage_page.php?action=tempfooter">' . _gettext('Edit Main Footer') . '</a></li>
		<li><a href="manage_page.php?action=boardhtml">' . _gettext('Edit boards.html') . '</a></li>
        ...
        $tpl_links .= section_html(_gettext('System Administration'), 'chanadministration') .
        '<ul>
        ...
        <li><a href="manage_page.php?action=spam">' . _gettext('Block &amp; Ban Content') . '</a></li>
        <li><a href="manage_page.php?action=blockfilter">' . _gettext('Block Content') . '</a></li>
        ...
        $tpl_links .= section_html(_gettext('Board Management'), 'boardsn') .
        '<ul>
    ...
    $tpl_links .= section_html(_gettext('Moderation'), 'mods') .
    '<ul>
    ...
    <li><a href="manage_page.php?action=chanspambl">' . _gettext('Chan Spam Blacklist') . '</a></li>
    <li><a href="manage_page.php?action=appeals">' . _gettext('View Appeals') . '</a></li>
